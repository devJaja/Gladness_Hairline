...
const InstallationClass = () => {
  ...
  return (
    <div className="bg-gray-100 min-h-screen py-8 mb-8 px-4">
      {/* Header Section */}
      <div className="text-center bg-[#4169E1] text-white py-10 rounded-lg">
      ...
      {/* Details Section */}
      <div className="max-w-6xl h-auto mx-auto mt-10 grid grid-cols-1 md:grid-cols-2 gap-10">
        {/* Course Details */}
        <div className="bg-white rounded-lg shadow-lg p-6">
          ...
          <button className="w-full bg-blue-500 text-white py-2 px-4 rounded-lg hover:bg-blue-400 font-semibold mt-8" onClick={handleClick} >Register</button>
        </div>
